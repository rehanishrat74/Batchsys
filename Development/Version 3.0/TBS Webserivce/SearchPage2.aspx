<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SearchPage2.aspx.vb" Inherits="tbs.infinishops.com.SearchPage2"%>
		...
		<form id="Form1" method="post" runat="server">
			<asp:panel id="PnlSearch" style="Z-INDEX: 101; LEFT: 40px; POSITION: absolute; TOP: 48px" runat="server"
				...
				<TABLE id="Table1" style="WIDTH: 656px; HEIGHT: 75px" cellSpacing="1" cellPadding="1" width="656"
					...
					<TR>
						<TD style="WIDTH: 174px; HEIGHT: 20px">
							<asp:Label id="lblProductCode" runat="server" Width="176px" Font-Bold="True" BorderStyle="None">Product Code</asp:Label></TD>
						</TD>
						<TD style="WIDTH: 113px; HEIGHT: 20px">
							<asp:TextBox id="txtProductCode" runat="server" Width="224px" Font-Bold="True" Enabled="False"></asp:TextBox></TD>
						</TD>
						<TD style="HEIGHT: 20px"></TD>
					</TR>
					<TR>
						<TD style="WIDTH: 174px; HEIGHT: 20px">
							<asp:Label id="lblPacketSize" runat="server" Width="176px" Font-Bold="True" BorderStyle="None">Packet Size</asp:Label></TD>
						</TD>
						<TD style="WIDTH: 113px; HEIGHT: 20px">
							<asp:TextBox id="txtPacketSize" runat="server" Width="224px" Font-Bold="True" Enabled="False"></asp:TextBox></TD>
						</TD>
						<TD style="HEIGHT: 20px"></TD>
					</TR>
					<TR>
						<TD style="WIDTH: 174px; HEIGHT: 20px">
							<asp:Label id="lblRegion" runat="server" Width="176px" Font-Bold="True" BorderStyle="None">Region</asp:Label></TD>
						</TD>
						<TD style="WIDTH: 113px; HEIGHT: 20px">
							<asp:TextBox id="txtRegion" runat="server" Width="224px" Font-Bold="True" Enabled="False"></asp:TextBox></TD>
						</TD>
						<TD style="HEIGHT: 20px"></TD>
					</TR>
				</TABLE>
