...
Module Common
    ...
    Public Function UpLoadSerials(ByVal str As String) As Boolean
        ...
        If Not str.Equals(String.Empty) Then
            '            Dim upload As New com.infinishops.tbs.tbsService
            Dim upload As New com.infinishops.tbs2.Service1
            'Dim netCredential As New Net.NetworkCredential("15kio", "786wwwio")

            'netCredential.UserName = "15kio"
            ''netCredential.Password = "786wwwio"
            'netCredential.Password = "hamidi78"
            'netCredential.Domain = "Infinilogic"
            'upload.Credentials = netCredential
        ...
        '''''' Old code 11 08 2008 Start
        'If Not str.Equals(String.Empty) Then
        '    '            Dim upload As New com.infinishops.tbs.tbsService
        '    Dim upload As New com.infinishops.tbs1.Service1
        '    'Dim netCredential As New Net.NetworkCredential("15kio", "786wwwio")
        ...
        '    'upload.Credentials = netCredential
        '    Try
        '        Select Case upload.UploadDataFromApp(str).ToLower
        '            Case "Success".ToLower
        '                Return True
        '            Case "Failed".ToLower
        '                Return False
    ...
    Public Function InsertSerialNo(ByRef SerialNo As String, ByVal ProductID As String, ByVal PacketSize As Integer, ByVal Region As String) As Boolean
        ...
        Return bRetrun
    End Function
    Public Function InsertSerialNo(ByRef SerialNo As String, ByRef HumanCode As String, ByVal Base64 As String, ByVal WithoutEQ As String, ByVal ProductID As String, ByVal PacketSize As Integer, ByVal Region As String, ByVal ProductPacketRegionID As Integer) As Boolean
        Dim bRetrun As Boolean = False
        Try
            Dim cmdText As String = "INSERT INTO serials(Serials,ProductCode,PacketSize,Region,ProdcutPacketRegionID,Human,Base64e,WithoutEQ)VALUES('" & SerialNo & "','" & ProductID & "'," & PacketSize & ",'" & Region & "','" & ProductPacketRegionID & "','" & HumanCode & "','" & Base64 & "' ,'" & WithoutEQ & "')"
    ...
    Public Function Insert_DublicateSerialNo(ByRef SerialNo As String, ByRef HumanCode As String, ByVal Base64 As String, ByVal WithoutEQ As String, ByVal ProductID As String, ByVal PacketSize As Integer, ByVal Region As String, ByVal ProductPacketRegionID As Integer) As Boolean
        Dim bRetrun As Boolean = False
        Try
            Dim cmdText As String = "INSERT INTO DM_Log(DM_Log)VALUES('" & SerialNo & "')"
            ExecuteQuery(cmdText, Execute.None)
        Catch ex As System.Data.OleDb.OleDbException
            If (ex.ErrorCode = -2147467259) Then
                bRetrun = True
